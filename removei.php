...
<body>
    ...
    <h3 align="center">Remove Items</h3>
    <div class="aa" align="center">
        <form method="POST">

            <label for="c1">ENTER ITEM CODE :</label>
            <input type="text" name="c1" class="control1">
            <br>
            <br>
            <br>
            <input type="submit" name="Submit" class="btn" style="margin-left: 200px;">
        </form>
    </div>
    <?php
    ...
    if (isset($_POST['Submit'])) {
        $code = $_POST['c1'];
        $q = "DELETE FROM items WHERE code = '$code'";
